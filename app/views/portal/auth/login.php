    ...
    <main class="w-full max-w-md relative z-10 flex flex-col">
        <div class="bg-white/5 backdrop-blur-md border border-white/10 p-5 sm:p-8 md:p-10 rounded-2xl shadow-2xl text-white">
            ...
            <div class="text-center mb-2">
                <div class="flex items-center justify-center">
                    <a href="" class="flex items-center gap-4">
                        ...
                        <div class="hidden sm:flex flex-col items-center">
                            <p id="title"
                                class="text-xl font-black tracking-[0.3em] uppercase text-red-600 transition-colors duration-300">
                                Nuevo Milenio
                            </p>
                ...
                <p id="subtitle"
                    class="text-lg sm:text-xl font-bold tracking-[0.25em] text-red-600 mt-3 transition-colors duration-300">
                    SISTEMA DE GESTIÓN INTERNA
                </p>

                <div id="divider"
                    class="h-1 w-24 bg-red-600 mx-auto mt-4 rounded-full transition-colors duration-300">
                </div>
            </div>

            <div class="my-5 flex items-center justify-center">
                <div class="relative flex items-center bg-white/5 border border-white/10 rounded-2xl p-1 w-full max-w-85 overflow-hidden">
                    ...
                    <button id="btnAspirante"
                        class="relative z-10 flex-1 h-12 rounded-xl text-sm font-semibold flex items-center justify-center gap-2 text-white/60 transition-all duration-300">
                        <span class="material-symbols-outlined text-[18px]">
                            school
                        </span>
                        Aspirantes
            ...
            <form action="<?= BASE_URL ?>auth/login" method="POST" class="space-y-5">
                ...
                <div class="flex items-center justify-between gap-4 text-sm">
                    ...
                    <a href="#" id="linkForgot" class="text-white/50 hover:text-red-500 transition-colors">
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function setRole(role) {
                if (role === "aspirante") {
                    ...
                    loginBtn.classList.replace("shadow-red-700/20", "shadow-blue-700/20");

                    indicator.classList.replace("bg-red-600", "bg-blue-600");
                    indicator.classList.replace("shadow-[0_0_25px_rgba(255,0,0,0.45)]", "shadow-[0_0_25px_rgba(37,99,235,0.45)]");
                    ...
                    checkRemember.classList.replace("text-red-600", "text-blue-600");
                    checkRemember.classList.replace("focus:ring-red-600", "focus:ring-blue-600");
                    linkForgot.classList.replace("hover:text-red-500", "hover:text-blue-500");
                    ...
                    loginBtn.classList.replace("shadow-blue-700/20", "shadow-red-700/20");

                    indicator.classList.replace("bg-blue-600", "bg-red-600");
                    indicator.classList.replace("shadow-[0_0_25px_rgba(37,99,235,0.45)]", "shadow-[0_0_25px_rgba(255,0,0,0.45)]");
                    ...
                    checkRemember.classList.replace("text-blue-600", "text-red-600");
                    checkRemember.classList.replace("focus:ring-blue-600", "focus:ring-red-600");
                    linkForgot.classList.replace("hover:text-blue-500", "hover:text-red-500");
